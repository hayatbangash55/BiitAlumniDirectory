...
public class UnPosted_Event_Activity extends AppCompatActivity {

    private UnPosted_Event_Adapter adapter_event;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unposted_event);

        getSupportActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable.background_gradient));
        getSupportActionBar().setElevation(0);
        getSupportActionBar().setTitle("UnPosted Events");
    ...
    public void get_data() {
        ...
        String query = "SJE_Detail/Select_UnPosted_Events?cnic="+login_cnic;

        final ArrayList<SJE_Detail> List_Event = new ArrayList<SJE_Detail>();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < arr.length(); i++) {
                                ...
                                SJE_Detail sjeDetail = new SJE_Detail(id_value, title_value,venue_value, starting_date, ending_date,  time_value,description_value, SJE_type_value, creatorCnic_value, creatorType_value);
                                List_Event.add(sjeDetail);
                            }

                            //Init adapter
                            adapter_event = new UnPosted_Event_Adapter(UnPosted_Event_Activity.this, List_Event);
