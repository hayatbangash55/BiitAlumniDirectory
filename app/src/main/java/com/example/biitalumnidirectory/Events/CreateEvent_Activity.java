    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_startingDate.getEditText().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePicker = new DatePickerDialog(CreateEvent_Activity.this,
        ...
        et_eventTime.getEditText().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // time picker dialog
                timePicker = new TimePickerDialog(CreateEvent_Activity.this,
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                if (!Msg.equals("")) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(CreateEvent_Activity.this);
