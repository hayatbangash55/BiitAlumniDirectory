...
public class Posted_Event_Activity extends AppCompatActivity {

    private Posted_Event_Adapter adapter_event;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Posted Events");
    ...
    public void get_data() {
        ...
        String query = "SJE_Detail/Select_Posted_Events?cnic="+login_cnic;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            //Init adapter
                            adapter_event = new Posted_Event_Adapter(Posted_Event_Activity.this, List_Event);
