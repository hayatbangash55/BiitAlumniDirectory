...
public class Survey_Statistics_Activity extends AppCompatActivity {
    ...
    String SJE_Detail_Id, Title;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey_statistics);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Survey_Statistics_Adapter adapter = new Survey_Statistics_Adapter(Survey_Statistics_Activity.this,Statistics_List);
                            RecyclerView.LayoutManager manager = new LinearLayoutManager(Survey_Statistics_Activity.this);
