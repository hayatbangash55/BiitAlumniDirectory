...
public class Posted_Survey_Activity extends AppCompatActivity {

    private Posted_Survey_Adapter adapter_survey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_posted_survey);

        getSupportActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable.background_gradient));
        getSupportActionBar().setElevation(0);
        getSupportActionBar().setTitle("Posted Survey");
    ...
    public void get_data() {
        ...
        String query = "SJE_Detail/Select_Posted_Surveys?cnic=" + login_cnic;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < arr.length(); i++) {
                                ...
                                SJE_Detail sjeDetail = new SJE_Detail(id_value, title_value, venue_value, Posted_Date,ending_date, Posted_Time, description_value, SJE_type_value, creatorCnic_value, creatorType_value);
                                List_Survey.add(sjeDetail);
                            }

                            //Init adapter
                            adapter_survey = new Posted_Survey_Adapter(Posted_Survey_Activity.this, List_Survey);
