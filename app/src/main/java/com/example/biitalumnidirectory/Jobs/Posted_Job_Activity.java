...
public class Posted_Job_Activity extends AppCompatActivity {

    private Posted_Job_Adapter adapter_job;
    ...
    public void get_data() {
        ...
        String query = "SJE_Detail/Select_Posted_Jobs?cnic="+login_cnic;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            //Init adapter
                            adapter_job = new Posted_Job_Adapter(Posted_Job_Activity.this, List_Job);
