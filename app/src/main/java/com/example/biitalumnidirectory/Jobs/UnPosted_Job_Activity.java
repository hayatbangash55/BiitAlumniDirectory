...
public class UnPosted_Job_Activity extends AppCompatActivity {

    private UnPosted_Job_Adapter adapter_job;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unposted_job);


        getSupportActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable.background_gradient));
        getSupportActionBar().setElevation(0);
        getSupportActionBar().setTitle("UnPosted Jobs");
    ...
    public void get_data() {
        ...
        String query = "SJE_Detail/Select_UnPosted_Jobs?cnic="+login_cnic;

        final ArrayList<SJE_Detail> List_Job = new ArrayList<SJE_Detail>();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < arr.length(); i++) {
                                ...
                                List_Job.add(sjeDetail);
                            }

                            //Init adapter
                            adapter_job = new UnPosted_Job_Adapter(UnPosted_Job_Activity.this, List_Job);
