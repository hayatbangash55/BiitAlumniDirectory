...
public class AddAlumni_Adapter extends RecyclerView.Adapter<AddAlumni_Adapter.ViewHolder>  {
    ...
    public AddAlumni_Adapter(Context mContext, ArrayList<Add_Group_Member> Student_list) {
    ...
    @NonNull
    @Override
    public AddAlumni_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_add_alumni, parent, false);
        AddAlumni_Adapter.ViewHolder holder = new AddAlumni_Adapter.ViewHolder(view);
        return holder;
    }


    @Override
    public void onBindViewHolder(@NonNull final AddAlumni_Adapter.ViewHolder holder, final int position) {
