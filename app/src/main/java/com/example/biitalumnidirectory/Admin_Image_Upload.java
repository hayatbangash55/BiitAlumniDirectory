...
public class Admin_Image_Upload extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                selectImage(Admin_Image_Upload.this);
            }
        });
    }
    ...
    void update_Data() {
        ...
        String query = "Admin_Detail/Update_admin_Image";
            ...
            switch (requestCode) {
                ...
                case 1:
                    if (resultCode == RESULT_OK && data != null) {
                        ...
                        try {
                            Bitmap bm = MediaStore.Images.Media.getBitmap(Admin_Image_Upload.this.getContentResolver(), selectedImage);
