...
public class Friends_Adapter extends RecyclerView.Adapter<Friends_Adapter.ViewHolder> {
    ...
    public Friends_Adapter(Context mContext, ArrayList<Friend> friend_list, FragmentManager manager) {
    ...
    public Friends_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Friends_Adapter.ViewHolder holder = new Friends_Adapter.ViewHolder(view);
        return holder;
    }


    @Override
    public void onBindViewHolder(@NonNull final Friends_Adapter.ViewHolder holder, final int position) {
