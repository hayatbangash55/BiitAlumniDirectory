...
public class RequestSent_Fragment extends Fragment {
    ...
    public void get_data() {
        ...
        friend_list.clear();
        String query = "Friends/Select_RequestSent?CNIC="+sharedRef.get_LoginCNIC();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            RequestSent_Adapter adapter = new RequestSent_Adapter(getContext(), friend_list, getActivity().getSupportFragmentManager());
