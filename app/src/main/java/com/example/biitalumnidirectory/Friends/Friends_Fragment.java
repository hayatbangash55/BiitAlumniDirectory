...
public class Friends_Fragment extends Fragment {
    ...
    public void get_data() {
        ...
        friend_list.clear();
        String query = "Friends/Select_Friends?CNIC="+sharedRef.get_LoginCNIC();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Friends_Adapter adapter = new Friends_Adapter(getContext(), friend_list, getActivity().getSupportFragmentManager());
