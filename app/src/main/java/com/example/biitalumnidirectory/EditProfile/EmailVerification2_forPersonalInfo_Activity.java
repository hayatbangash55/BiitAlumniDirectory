...
public class EmailVerification2_forPersonalInfo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_verification2_for_personal_info);
    ...
    void update_email(String val) {

        final String temp = SharedRef.get_LoadUserDataByCNIC();
        String Query = "Student_Detail/Update_Student_Email?cnic=" + temp + "&email=" + val;
