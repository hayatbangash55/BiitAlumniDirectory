...
public class Add_FamilyInfo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Family Detail");
        ...
        btn_updateImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                selectImage(Add_FamilyInfo_Activity.this);
            }
        });
    ...
    void save_Data() {
        ...
        if (name.equals("") || relation.equals("")) {
            ...
            String Query = "Student_Family_Detail/Insert_Student_Family_Detail";
